                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-primary">Total Active Users : {{ $users_count }}</h6>
                        </div>
                        <div class="card-body">
                                    ...
                                    <tbody>
                                      ...
                                      @foreach($users as $user)
                                        <tr>
                                            ...
                                            <td>
                                                 <button class="btn btn-success edit btn-sm" data-sets="username,phone_number" data-url="/admin/active/users" data-id="<?php echo $user->parent_id_user; ?>"><span class="fas fa-edit"></span> Edit</button>
                                                 <a class="btn btn-danger delete btn-sm" href="/admin/active/users/delete/{{ $user->parent_id_user }}?access_token={{ csrf_token() }}" ><span class="fas fa-trash"></span> Delete</a>
                                            </td>
                                        </tr>
                                    @endforeach
                                    </tbody>
    ...
    <!-- End of Page Wrapper -->
     ...
     <div id="edit-modal" class="modal fade" tabindex="-1" role="dialog">
        ...
        <div class="modal-content text-dark">
            ...
            <form class="edit-form" method="POST" action="/admin/active/users/edit">
            {{ csrf_field() }}
