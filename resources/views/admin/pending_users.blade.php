                                    ...
                                    <tbody>
                                      ...
                                      @foreach($users as $user)
                                        <tr>
                                            ...
                                            <td>
                                                 <a class="btn btn-success approve btn-sm" href="/admin/pending/users/action/approve/{{ $user->parent_id_user }}?access_token={{ csrf_token() }}" ><span class="fas fa-edit"></span> Approve</a>
                                                 <a class="btn btn-danger delete btn-sm" href="/admin/pending/users/action/delete/{{ $user->parent_id_user }}?access_token={{ csrf_token() }}" ><span class="fas fa-trash"></span> Delete</a>
                                            </td>
                                        </tr>
                                    @endforeach
                                    </tbody>
